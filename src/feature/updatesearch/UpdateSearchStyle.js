...
export const UpdateSearchLoadingContainer = styled("div")(({ theme }) => ({
  width: "100%",
  height: "100%",
  display: "flex",
  flexDirection: "column",
...
export const UpdateSearchLoadingGroup1 = styled("div")(({ theme }) => ({
  width: "100%",
  display: "flex",
  flexWrap: "wrap",
  justifyContent: "flex-start",
...
export const UpdateSearchLoadingGroup1Item = styled("div")(({ theme }) => ({
  display: "flex",
  flexDirection: "column",
...
export const UpdateSearchLoadingItem = styled("div")(({ theme }) => ({
